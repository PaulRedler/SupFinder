...
#[Route('/niveau/formation')]
final class NiveauFormationController extends AbstractController
{
    #[Route(name: 'app_niveau_formation_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_niveau_formation_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_niveau_formation_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->render('niveau_formation/new.html.twig', [
            'niveau_formation' => $niveauFormation,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_niveau_formation_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_niveau_formation_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, NiveauFormation $niveauFormation, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('niveau_formation/edit.html.twig', [
            'niveau_formation' => $niveauFormation,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_niveau_formation_delete', methods: ['POST'])]
    public function delete(Request $request, NiveauFormation $niveauFormation, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$niveauFormation->getId(), $request->getPayload()->getString('_token'))) {
